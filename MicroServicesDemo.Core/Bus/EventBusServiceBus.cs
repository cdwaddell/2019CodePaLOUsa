...
namespace MicroServicesDemo.Bus
{
    ...
    public class EventBusServiceBus : IEventBus
    {
        ...
        public EventBusServiceBus(IServiceBusPersisterConnection serviceBusPersisterConnection, IServiceProvider provider,
            ...
            if (_subsManager.HasSubscriptionsForEvent(eventName))
            {
                ...
                using (var scope = scopeFactory.CreateScope())
                {
                    ...
                    foreach (var subscription in subscriptions)
                    {
                        ...
                        {
                            var handler = provider.GetService(subscription.HandlerType) as IDynamicIntegrationEventHandler;
